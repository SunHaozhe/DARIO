...
@measure('composite_l0_var', bn=False, mode='param')
def get_composite_l0_var_array(net, head_mask, alphas, inputs, targets, mode, split_data=1, loss_fn=None):
    ...
    # combining l0_norm_v4 and param_var_v2
    all_norms = []
    all_parameters = []
    ...
    l0_term = torch.mean(all_norms)
    var_term = torch.var(all_parameters)
    coef_ = 22516549.4  # empirical coefficient
    
    res = [l0_term - var_term * coef_]
